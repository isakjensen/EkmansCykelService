...
<nav>
    <!-- Desktop -->
    <section class="flex flex-row justify-between px-8 sm:px-12 md:px-20 lg:px-24 xl:px-64 2xl:px-96 p-14">
        <svg class="justify-start hidden lg:block" width="56" height="56" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="flex flex-col lg:hidden w-full h-full fixed top-0">
        <div class="flex flex-row gap-8 px-6 p-8 bg-sky-600">
            <button on:click={() => toggleMenu()}>
                <svg class="text-blue-900" width="36" height="36" fill="none" viewBox="0 0 24 24">
